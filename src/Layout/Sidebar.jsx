...
export default function Sidebar() {
  ...
  const links = [
    { path: "/attendance-dummy", label: "RFID Attendance", icon: <FaUserCheck /> },
    { path: "/assign-dummy", label: "RFID Assignment", icon: <FaIdCard /> },
    { path: "/attendance-report", label: "RFID Attendacne Report", icon: <FaIdCard /> },
  ];
